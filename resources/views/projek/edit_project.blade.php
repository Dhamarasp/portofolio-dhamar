...
<div class="card shadow justify">
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" name="nama_projek" value="{{$projects->nama_projek}}" id="nama_projek" class="form-control">
            </div>
        </div>
        <div class="form-group row">
            <label for="deskripsi" class="col-sm-3 col-form-label">Deskripsi</label>
            <div class="col-sm-5">
                <textarea type="text" name="deskripsi" id="deskripsi" rows="3" class="form-control">{{$projects->deskripsi}}</textarea>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <div class="custom-file">
                    ...
                    <div class="col-sm-5">
                        @if($projects->foto)
                            <img src="{{asset('storage/'.$projects->foto)}}" class="img-preview img-fluid w-80 mt-5">
                        @else

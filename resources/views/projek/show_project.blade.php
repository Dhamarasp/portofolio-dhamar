    ...
    <div class="card shadow mb-3 p-2">
      <div class="card-body">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-7">
            <img src="{{ asset('images/project.png') }}" class="rounded w-100" alt="Foto Projek">
          </div>
          <div class="col-md-5">
      ...
      <div class="card-footer">
        <div class="row justify-content-between align-items-center">
            <div class="col-md-6 text-left">
                <a href="{{route('masterproject.edit', $projek['id'])}}" class="btn btn-circle btn-sm btn-primary"><i class="fas fa-edit"></i></a>

                <form method="POST" action="{{route('masterproject.destroy', $projek->id)}}" onclick="return confirm('Apakah anda yakin akan menghapus project ini?')" class="d-inline">
                    @csrf
                    @method('DELETE')

        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <form action="{{ route('logout') }}" method="POST" onclick="return confirm('Yakin Logout?')">
                        @csrf
                        <button class="dropdown-item" type="submit" name="submit"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>Logout</button>
                    </form>
                </div>
            </li>

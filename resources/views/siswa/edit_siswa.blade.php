...
<div class="card shadow justify">
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <div class="custom-file">
                    ...
                    <div class="col-sm-5">
                        @if($siswas->foto)
                            <img src="{{asset('storage/'.$siswas->foto)}}" class="img-preview img-fluid w-70 mt-5">
                        @else
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <textarea type="text" name="tentang" id="tentang" rows="3" class="form-control">{{$siswas->tentang}}</textarea>
            </div>
        </div>
